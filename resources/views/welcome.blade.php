        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-8">
                    ...
                    <div class="hidden md:flex space-x-4">
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute hidden group-hover:block bg-white shadow-lg p-2 rounded w-40">
                                <a href="#" class="block px-4 py-2 hover:bg-blue-50">Politik</a>
                                <a href="#" class="block px-4 py-2 hover:bg-blue-50">Olahraga</a>
                                <a href="#" class="block px-4 py-2 hover:bg-blue-50">Teknologi</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="/admin/login" class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700">Masuk</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <section class="mb-10">
            ...
            <div class="relative h-64 md:h-[450px] bg-gray-900 rounded-2xl overflow-hidden shadow-xl group">
                ...
                <div class="absolute bottom-0 left-0 p-8 text-white w-full bg-gradient-to-t from-black via-black/50 to-transparent">
                    <span class="bg-blue-600 px-3 py-1 rounded-full text-xs uppercase font-bold">Berita Terbaru</span>

                    <h2 class="text-2xl md:text-4xl font-bold mt-3 leading-tight">
                        <a href="#" class="hover:text-blue-400 transition">{{ $headline->title }}</a>
                    </h2>
